...
exports.defaultHomepageContent = void 0;
exports.initializeHomepageContent = initializeHomepageContent;
...
exports.defaultHomepageContent = defaultHomepageContent;
async function initializeHomepageContent() {
    try {
        console.log('🚀 Initializing homepage content...');
        // Check if content already exists
        const existingContent = await homepageService_1.homepageService.getAllContent();
        ...
        // Hero section
        await homepageService_1.homepageService.upsertContent({
            section: 'hero',
            fieldName: 'title',
        ...
        await homepageService_1.homepageService.createVersion('Initial content', defaultHomepageContent);
...
//# sourceMappingURL=init-homepage.js.map