...
export interface ProjectStep1Props {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  initialData?: Partial<ProjectStep1Data>;
  heroImage?: string;
  onNext: (data: ProjectStep1Data & { heroImageFile?: File }) => void;
}
...
export function ProjectFormStep1({ open, onOpenChange, initialData, heroImage, onNext }: ProjectStep1Props) {
  const [heroImageFile, setHeroImageFile] = useState<File | null>(null);
  const [heroImagePreview, setHeroImagePreview] = useState<string>(heroImage || '');
  ...
  const handleNext = (data: ProjectStep1Data) => {
    onNext({ ...data, heroImageFile: heroImageFile || undefined });
  };
